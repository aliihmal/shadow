...
import "./PackagingMachinesPage.css";
...
export default function PackagingMachinesPage() {
  ...
  return (
    <div className="page">
      ...
      {/* MACHINES */}
      <section className="packaging-machines">
        <div className="container">

          <div className="packaging-machines__head">
          ...
          <div className="packaging-machines__grid">

            {machines.map((machine) => (

              <Link
                key={machine.id}
                to={`/category/packaging-machines/machine/${machine.id}`}
                className="packaging-machine-box"
              >

                <div className="packaging-machine-box__image">
                ...
                <div className="packaging-machine-box__content">
